<!-- =========================================================
  GitHub Profile README — MD Rohan Islam
  Notes:
  - Keep widths responsive (avoid fixed widths when possible).
  - Prefer SVG badges for crisp rendering.
  - Replace any placeholder links/text marked as TODO.
========================================================= -->
...
<!-- Quick value proposition (professional tone) -->
<img
...
education: Final-year CSE Student @ BUBT
company: IT Training BD (Designer & Video Editor)
blood_group: O+

currently:
  - Android Development (Java/Kotlin)
  - Firebase/Room + clean architecture patterns
  - UI/UX Design & Motion
  - AI/ML feature integration (practical, product-focused)
...
- Android (Junior) roles / internships
- Remote freelance Android & web projects
...
- Strong in **Android (Java)** + growing in **Kotlin & Jetpack Compose**
- Built apps using **SQLite / Room / Firebase**
- Comfortable with **React + Node/Express + PHP/MySQL**
- Visual-first mindset: **UI/UX, motion, and polished interfaces**

---

## Tech Stack (clean & professional)
...
> Hand-picked projects with clear outcomes and tech details.
...
<p align="center">
  <sub>
    ...
    <a href="https://rohann-portfolio.netlify.app/">Portfolio</a> •
